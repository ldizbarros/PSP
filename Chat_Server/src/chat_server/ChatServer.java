 ...
 * O servidor:
 * 1. Permitirá conectar varios clientes de chat simultanemente, ata un máximo de 10. X
 * 2. Disporá dunha única sala de chat á que se conectarán todos os clientes. X
 * 3. Cada usuario terá un nickname que se lle solicitará antes de establecer  
 * a conexión co servidor. V
 * 4. Amosará por pantalla todas as mensaxes que se reciban desde os clientes 
 * a medida que van chegando, indicando "nickname: mensaxe..." V
 * 5. Cada mensaxe que se reciba será reenviado a todos os clientes, incluíndo 
 * o nickname correspondente. X
 * 6. Ao arrancar o servidor, se solicitará o porto polo que se establecerá a conexión. V
 * 7. Cada vez que se conecte un novo cliente, indicarase por pantalla:
 *      Novo cliente conectado (nickname / enderezo IP / porto ) V
 *      Actualmente hai x usuarios conectados.
 * 8. Mentras non se conecte ningún usuario, ou se todos os clientes se desconectan, 
 * amosarase a mensaxe "Ningún cliente conectado". X
